...
namespace Ch11_HashingApp
{
    class Program
    {
        ...
        {
            WriteLine("A user named Dane has been registered with Pa$$w0rd as his password.");
            var dane = Protector.Register("Dane", "Pa$$w0rd");
            WriteLine($"Name: {dane.Name}");
            WriteLine($"Salt: {dane.Salt}");
            WriteLine($"Salted and hashed password: {dane.SaltedHashedPassword}");
            WriteLine();
